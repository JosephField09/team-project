...
<section id="header">
    <nav>
        ...
        <div class="navbar-right">
            <a class="account" href="/team-project/resources/views/basket.blade.php"><i class='bx bx-user'></i></a>
...
<x-app-layout>
    ...
    <form method="POST" action="http://127.0.0.1:8000/logout">
                            <input type="hidden" name="_token" value="P0AdiQgY9zQbsPmvGkwmhGeVQ4pfIUq2NXfqmJrH" autocomplete="off">
